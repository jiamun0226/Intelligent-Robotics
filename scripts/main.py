...
if (len(face_boxes) > 0):
    ...
    #name = file1.read()
    file = open('/home/jiamun/catkin_ws/src/robocup_pkg/launch/feature.txt', 'w')
    gender_label = label.split(',')[0]

    file.write(gender_label)
    file.close()
...
# Write output frame
out.write(faces_bgr)
cv.imwrite('/home/jiamun/catkin_ws/src/robocup_pkg/launch/temp.jpeg', faces_bgr)
# cv.imshow('temp.jpeg', faces_bgr)
#image = cv.imread('temp.jpeg')
# show the image, provide window name first
#cv.imshow('Gender', image)
cv.waitKey(0)
